#the source code is taken from https://github.com/Bablofil/binance-api
import ssl
import time
import json
import urllib
...
class Binance():
    ...
    methods = {
            ...
            'futuresTrades':           {'url': 'fapi/v1/trades', 'method': 'GET', 'private': False, 'futures': True}, 
            ...
            'futuresOrders': {'url': 'fapi/v1/allOrders', 'method': 'GET', 'private': True, 'futures': True}, 
            'userOpenOrders': {'url': 'fapi/v1/openOrders', 'method': 'GET', 'private': True, 'futures': True}, 
            'userTrades': {'url': 'fapi/v1/userTrades', 'method': 'GET', 'private': True, 'futures': True}, 
            'userPositions': {'url': 'fapi/v1/adlQuantile', 'method': 'GET', 'private': True, 'futures': True}, 
            'income': {'url': 'fapi/v1/income', 'method': 'GET', 'private': True, 'futures': True}, 
            'forceOrders': {'url': 'fapi/v1/forceOrders', 'method': 'GET', 'private': False, 'futures': True}, 
            'userPositionInfo': {'url': 'fapi/v2/positionRisk', 'method': 'GET', 'private': True, 'futures': True}, 
            'ftrsGetPositionSide': {'url': 'fapi/v1/positionSide/dual', 'method': 'GET', 'private': True, 'futures': True}, 
            'futuresChLeverage': {'url': 'fapi/v1/leverage', 'method': 'POST', 'private': True, 'futures': True}, 
            'futuresChMarginType': {'url': 'fapi/v1/marginType', 'method': 'POST', 'private': True, 'futures': True}, 
   }
    ...
    def call_api(self, **kwargs):
        ...
        if 'code' in response.text:
            #print(response.text)
            if command=='futuresChMarginType' and '"code": 200' in response.text:
                tmp=0 # Null code (plug)
            else:
